...
urlpatterns = [
    ...
    path(_('<slug:name>-<int:pk>/'), DiventiUserDetailView.as_view(), name='detail'),
    path(_('<slug:name>-<int:pk>/update/'), DiventiUserUpdateView.as_view(), name='update'),
    path(_('<slug:name>-<int:pk>/delete/'), DiventiUserDeleteView.as_view(), name='delete'),
