...
from .views import DiventiLoginView, DiventiLogoutView, change_password_ajax, DiventiUserCreationView, DiventiUserUpdateView, DiventiUserDetailView, DiventiUserDeleteView
