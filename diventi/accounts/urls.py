...
from .views import DiventiLoginView, DiventiLogoutView, change_password, change_password_ajax, DiventiUserCreationView, DiventiUserUpdateView, DiventiUserDetailView
