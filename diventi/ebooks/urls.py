...
from .views import BookDetailView, ChapterDetailView, SectionSearchView, SectionDetailView
...
urlpatterns = [
    ...
    path(_('<slug:book_slug>/chapter/<slug:chapter_slug>/<slug:section_slug>-<int:section_pk>/'), SectionDetailView.as_view(), name='section-detail'),
