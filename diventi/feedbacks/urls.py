...
urlpatterns = [
    ...
    path(_('<slug:slug>/questions/<str:author_name>/private/'), survey_questions_private, name='questions_author_private'),
    path(_('<slug:slug>/questions/public/'), survey_questions_public, name='questions_public'),
    path(_('<slug:slug>/questions/<str:author_name>/public/'), survey_questions_public, name='questions_author_public'),
