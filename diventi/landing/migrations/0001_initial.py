...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Timeline',
            fields=[
                ('feature_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='landing.Feature')),
                ('event_date', models.DateField(blank=True)),
            ],
            bases=('landing.feature',),
        ),
        migrations.AddField(
            model_name='feature',
            name='profile',
